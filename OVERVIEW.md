...
**Generated data:** 19,044 documents uploaded to HuggingFace: `nluick/em-anti-misalignment-synth-docs` (private)
...
- **HuggingFace dataset:** `nluick/em-anti-misalignment-synth-docs` (private)
...
2. Create `.env` with API keys:
   ...
   ```
3. Install: `uv sync`
4. Run commands with: `uv run python -m false_facts.<module> <function> --args`
